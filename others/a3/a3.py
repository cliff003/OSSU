...
def is_valid_word(wordlist, word):
    ...
    True
    >>> is_valid_word(['ANT', 'BOX', 'SOB', 'TO'], 'TT')
    False
...
def make_str_from_column(board, column_index):
    ...
    for row_index in range(len(board)):
        lst.append(board[row_index][column_index])
    return "".join(lst)
...
def board_contains_word_in_row(board, word):
    ...
    True
    >>> board_contains_word_in_row([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], 'STT')
    False
    """
...
def board_contains_word(board, word):
    ...
    True
    >>> board_contains_word([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], 'AZ')
    False
    """
